...
export const WaterSupplyNotesPage = ({ title }: { title: string }) => {
    const { fetchData, createRow, deleteRow, updateRow, isCreating, waterSupplyNotes, columns, isDeleting, isFetching, isUpdating } = useWaterSupplyNotes();
...
export default WaterSupplyNotesPage;
