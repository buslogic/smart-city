...
export const WaterServicesPricelistHistoryPage = ({ title }: { title: string }) => {
        ...
        <DatePicker
          ...
          onChange={(newValue) => {
            ...
            if (pricelistId !== undefined) {
              fetchPricelistHistoryRows(pricelistId, newValue, endDate);
            }
          }}
        />
        <DatePicker
          ...
          onChange={(newValue) => {
            setEndDate(newValue);
            if (pricelistId !== undefined) {
              fetchPricelistHistoryRows(pricelistId, startDate, newValue);
            }
          }}
        />
      </Box>
...
export default WaterServicesPricelistHistoryPage;
