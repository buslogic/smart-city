...
import MainServerTab from './components/timetable-sync/MainServerTab';
import TicketingServerTab from './components/timetable-sync/TicketingServerTab';
import CityServerTab from './components/timetable-sync/CityServerTab';

const { Title } = Typography;

const TimetableSync: React.FC = () => {
  ...
  const tabItems = [
    {
      ...
      permission: 'transport.administration.timetable_sync.main:view',
    },
    {
      ...
      permission: 'transport.administration.timetable_sync.ticketing:view',
    },
    {
      key: 'city-server',
      label: (
      ...
      permission: 'transport.administration.timetable_sync.city:view',
    },
  ];
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <Title level={2}>RedVoznje Sync.</Title>
      </div>
