...
const TicketingServerTab: React.FC = () => {
  ...
  const handleSync = () => {
    ...
    modal.confirm({
      ...
      content: (
        <div>
          <p>Da li ste sigurni da želite da pokrenete sinhronizaciju RedVoznje sa Tiketing servera?</p>
          <p>
            <Text type="warning">
      ...
      onOk: async () => {
        ...
        setSyncResult(null);
        try {
          const result = await timetableSchedulesService.syncFromTicketing(selectedGroup);
    ...
    <div>
      <Card className="mb-4">
        <Row justify="space-between" align="middle">
          ...
          <Col>
            {hasPermission('transport.administration.timetable_sync.ticketing:sync') && (
              <Button
                type="primary"
