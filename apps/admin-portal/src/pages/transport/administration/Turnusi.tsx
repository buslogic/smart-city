...
import MainServerTab from './components/turnusi/MainServerTab';
import TicketingServerTab from './components/turnusi/TicketingServerTab';
import CityServerTab from './components/turnusi/CityServerTab';

const { Title } = Typography;

const Turnusi: React.FC = () => {
  ...
  const tabItems = [
    {
      ...
      permission: 'transport.administration.turnusi.main:view',
    },
    {
      ...
      permission: 'transport.administration.turnusi.ticketing:view',
    },
    {
      key: 'city-server',
      label: (
      ...
      permission: 'transport.administration.turnusi.city:view',
    },
  ];
