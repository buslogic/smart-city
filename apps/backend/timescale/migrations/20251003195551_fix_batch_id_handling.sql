-- migrate:up
-- ==============================================================================
-- FIX: Batch ID handling u process_gps_batch funkciji
-- ==============================================================================
-- Problem: ON CONFLICT DO UPDATE ponekad ne vraća ID ispravno
-- Rešenje: Eksplicitno čitaj ID nakon INSERT/UPDATE
-- ==============================================================================
...
FIX: Eksplicitno pronađe batch_id nakon INSERT/UPDATE operacije.';
