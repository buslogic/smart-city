...
export class TurnusiSyncController {
  ...
  @ApiResponse({ status: 200, description: 'Lista grupa turnusa' })
  @RequirePermissions('transport.administration.turnusi_sync.city:view')
  getAllGroupsCity() {
    return this.turnusiSyncService.getAllGroupsCity();
  }
  ...
  @ApiQuery({ name: 'limit', required: false, type: Number })
  @RequirePermissions('transport.administration.turnusi_sync.city:view')
  getAllAssignCity(@Query() query: QueryTurnusiDto) {
    return this.turnusiSyncService.getAllAssignCity(
      query.groupId,
      query.page,
      query.limit,
    );
  ...
  @ApiQuery({ name: 'limit', required: false, type: Number })
  @RequirePermissions('transport.administration.turnusi_sync.city:view')
  getAllDaysCity(@Query() query: QueryTurnusiDto) {
    return this.turnusiSyncService.getAllDaysCity(
      query.groupId,
      query.page,
      query.limit,
    );
  ...
  @RequirePermissions('transport.administration.turnusi_sync.city:sync')
  async syncFromCity(@Req() req: Request) {
    const userId = (req.user as any)?.id || 1;
    return this.turnusiSyncService.syncAllFromCity(userId);
  }
