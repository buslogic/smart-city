...
export const SUBTYPE_DESCRIPTIONS = {
  [LEGACY_DATABASE_SUBTYPES.MAIN_TICKETING]:
    'Osnovna baza za ticketing sistem sa glavnim podacima',
  [LEGACY_DATABASE_SUBTYPES.GPS_TICKETING]:
    'Baza sa GPS podacima vozila i ruta',
  [LEGACY_DATABASE_SUBTYPES.GLOBAL_TICKETING]:
    'Globalna baza sa ukupnim ticketing podacima',
  [LEGACY_DATABASE_SUBTYPES.CITY_TICKETING]:
    'Gradska baza sa lokalnim ticketing informacijama',
};

export type LegacyDatabaseSubtype =
  (typeof LEGACY_DATABASE_SUBTYPES)[keyof typeof LEGACY_DATABASE_SUBTYPES];
